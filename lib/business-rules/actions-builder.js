(function($) {
  ...
  ActionsBuilder.prototype = {
      ...
      select.change(function() {
        ...
        if(newField.params) {
          for (var key in newField.params) {
            fieldsDiv.append(_this.buildField(newField.params[key].name, newField.params[key].fieldType, newField.params[key]));
          }
        }
    ...
    buildField: function(fieldName, fieldType, field) {
        ...
        select.change(function() {
          ...
          if(optionData.params) {
            for(var i=0; i < optionData.params.length; i++) {
              ...
              subfields.append(_this.buildField(f.name, f.fieldType, f));
            }
          }
        });
